...
export function mountAdminSidebar(opts = {}) {
    ...
    // Same carve-out as the public sidebar: moving a node re-inserts it, which
    // restarts its CSS animations. The splash would replay its entrance
    // mid-load and look like a second loading screen. See siteSidebar.js.
