    ...
    // ============ 5b · Total PR ↔ Result (player page) ============
    {
        ...
        render(lang) {
            return lang === 'he' ? `
                ...
                <p>מעל כל גרף יושב פס יחיד: המילה <b>Luck</b>, סקאלת צבע עם סמן ומספר, והמסקנה במילים (למשל &rlm;<b>Slightly lucky</b>). הגרף מראה <i>כמה טוב</i> השחקן שיחק בכל משחק; הפס מסכם ב<b>מספר אחד</b> את השאלה הנפרדת &mdash; האם התוצאות שיצאו לו היו טובות יותר או פחות ממה שרמת המשחק שלו הצדיקה.</p>
                <p>הפס מתאר בדיוק את המשחקים המצוירים מתחתיו: הוא מחושב מחדש כשמחליפים סוג ליגה או אורך משחק, ולכל גרף בערימה יש פס משלו. אותם משחקים בדיוק שנספרים בכותרת (<span dir="ltr">x/y matches</span>) הם שנכנסים לחישוב. זהו אותו מדד ממש המוצג בכרטיס <b>Luck Percentile</b> בעמוד הבית ובסקשן <b>Total Luck</b>, ובאותה סקאלה &mdash; ההבדל הוא רק אילו משחקים נכללים.</p>
                ${luckConfidenceExplainerHtml('he')}
            ` : `
