...
export function installSectionLinkScroll() {
    ...
    document.addEventListener('click', e => {
        ...
        // Byte-for-byte comparison, so it depends on nothing having re-serialised
        // the address bar behind our back — see CLAUDE.md § URL contract for why
        // query strings are spliced, never rebuilt from URLSearchParams.
