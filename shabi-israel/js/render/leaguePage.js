...
export async function renderLeaguePage() {
    ...
    try {
        ...
        // `__initial__` is the league before anything was played (see
        // INITIAL_POINT): always available, even for a league whose match_history
        ...
        renderV13Header(
            ...
            {
                omitStartDate: true,
                historicalNote: isInitial
                    ? 'Initial version — before any match was played'
                    : isHistorical
