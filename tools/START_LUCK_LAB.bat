...
REM ============================================================
REM  START_LUCK_LAB.bat — start the dev server (if needed) and open
REM  the Luck Metrics Lab (question-mark explanations + Luck Confidence Lab).
REM ============================================================

set "URL=http://localhost:8090/luck-lab.html"
