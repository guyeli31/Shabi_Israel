/**
 * adminButton.js — Floating admin button (bottom-left), mirrors theme picker style.
 */
...
export function initAdminButton() {
    ...
    link.className = 'admin-button-toggle';
    link.setAttribute('aria-label', 'Admin Mode');
    link.innerHTML = GEAR_SVG;
